...
(function addChatSearchStyles() {
  ...
  ` ;
    ...
    const append = () => { if (document.head) document.head.appendChild(style); };
...
(async function() {
    ...
    const petitems3 = ["CowtailStrap", "FoxTailsStrap", "FoxTailStrap1", "FoxTailStrap2", "HorseTailStrap", "HorseTailStrap1", "KittenTailStrap1", "KittenTailStrap2", "LargeBushyTail", "MouseTailStrap1", "MouseTailStrap2", "PuppyTailStrap", "PuppyTailStrap1", "RaccoonStrap", "RaccoonTailStrap", "TailStrap", "WolfTailStrap1", "WolfTailStrap2", "WolfTailStrap3"];
        ...
        modApi.hookFunction('TitleLoad', 4, (args, next) => {
            if (alftitle == true) {
                TitleList = [{
                    ...
                    {
                        Name: "InfilrationAgent",
                        Requirement: function() {
                            return ((SkillGetLevel(Player, "Infiltration") == 6) || (SkillGetLevel(Player, "Infiltration") == 7));
                        },
                        Earned: true
                    },
                    {
                    ...
                    },
                    {
                        Name: "BondageBaby",
                        Requirement: function() {
                            return ((SkillGetLevel(Player, "Evasion")) >= 10 && (ReputationGet("ABDL") >= 1));
                        },
                        Earned: true
                    },
                    {
                        Name: "BondageMaid",
                        Requirement: function() {
                            return ((LogQuery("JoinedSorority", "Maid") || LogQuery("LeadSorority", "Maid")) && SkillGetLevel(Player, "Evasion") >= 10);
                        },
                        Earned: true
                    },
                    {
                    ...
                    },
                    {
                        Name: "PonyCold",
                        Requirement: function() {
                            return (SkillGetLevel(Player, "Dressage") == 3);
                        },
                        Earned: true
                    },
                    {
                        Name: "CollegeStudent",
                        Requirement: function() {
                            return LogQuery("BondageCollege", "Import");
                        },
                        Earned: true
                    },
                    {
                    ...
                    },
                    {
                        Name: "Doctor",
                        Requirement: function() {
                            return (ReputationGet("Asylum") >= 100);
                        },
                        Earned: true
                    },
                    {
                    ...
                    },
                    {
                        Name: "Drone",
                        Requirement: function() {
                            return (AsylumGGTSGetLevel(Player) >= 6);
                        },
                        Earned: true
                    },
                    {
                        Name: "Duchess",
                        Requirement: function() {
                            return LogQuery("KidnapSophie", "Sarah") && !Player.GenderSettings.HideTitles.Female;
                        },
                        Earned: true
                    },
                    {
                        Name: "Duke",
                        Requirement: function() {
                            return LogQuery("KidnapSophie", "Sarah") && !Player.GenderSettings.HideTitles.Male;
                        },
                        Earned: true
                    },
                    {
                        Name: "EscapedPatient",
                        Requirement: function() {
                            return (LogValue("Escaped", "Asylum") >= CurrentTime);
                        },
                        Force: true
                    },
                    {
                        Name: "PonyFarm",
                        Requirement: function() {
                            return (SkillGetLevel(Player, "Dressage") == 2);
                        },
                        Earned: true
                    },
                    {
                        Name: "Femboy",
                        Requirement: function() {
                            return !Player.GenderSettings.HideTitles.Male;
                        }
                    },
                    {
                        Name: "PonyPegasus",
                        Requirement: function() {
                            return ((SkillGetLevel(Player, "Dressage") >= 8) && (SkillGetLevel(Player, "Dressage") <= 9));
                        },
                        Earned: true
                    },
                    {
                        Name: "PonyFoal",
                        Requirement: function() {
                            return ((SkillGetLevel(Player, "Dressage") == 1) || ((SkillGetLevel(Player, "Dressage") >= 1) && (ReputationGet("ABDL") >= 1)));
                        },
                        Earned: true
                    },
                    {
                    ...
                    },
                    {
                        Name: "GoodBoy",
                        Requirement: function() {
                            return (AsylumGGTSGetLevel(Player) >= 4) && !Player.GenderSettings.HideTitles.Male;
                        },
                        Earned: true
                    },
                    {
                        Name: "GoodGirl",
                        Requirement: function() {
                            return (AsylumGGTSGetLevel(Player) >= 4) && !Player.GenderSettings.HideTitles.Female;
                        },
                        Earned: true
                    },
                    {
                    ...
                    },
                    {
                        Name: "GoodSlaveBoy",
                        Requirement: function() {
                            return (AsylumGGTSGetLevel(Player) >= 5) && !Player.GenderSettings.HideTitles.Male;
                        },
                        Earned: true
                    },
                    {
                        Name: "GoodSlaveGirl",
                        Requirement: function() {
                            return (AsylumGGTSGetLevel(Player) >= 5) && !Player.GenderSettings.HideTitles.Female;
                        },
                        Earned: true
                    },
                    {
                    ...
                    },
                    {
                        Name: "PonyHot",
                        Requirement: function() {
                            return (SkillGetLevel(Player, "Dressage") == 5);
                        },
                        Earned: true
                    },
                    {
                        Name: "Houdini",
                        Requirement: function() {
                            return (SkillGetLevel(Player, "Evasion") >= 10);
                        },
                        Earned: true
                    },
                    {
                    ...
                    {
                        Name: "InfilrationInfiltrator",
                        Requirement: function() {
                            return ((SkillGetLevel(Player, "Infiltration") == 4) || (SkillGetLevel(Player, "Infiltration") == 5));
                        },
                        Earned: true
                    },
                    {
                        Name: "Kidnapper",
                        Requirement: function() {
                            return ((ReputationGet("Kidnap") >= 50) && (ReputationGet("Kidnap") < 100));
                        },
                        Earned: true
                    },
                    {
                    ...
                    },
                    {
                        Name: "LadyLuck",
                        Requirement: function() {
                            return (ReputationGet("Gambling") >= 100) && !Player.GenderSettings.HideTitles.Female;
                        },
                        Earned: true
                    },
                    {
                    ...
                    },
                    {
                        Name: "LordFortune",
                        Requirement: function() {
                            return (ReputationGet("Gambling") >= 100) && !Player.GenderSettings.HideTitles.Male;
                        },
                        Earned: true
                    },
                    {
                        Name: "MagicSchoolMagician",
                        Requirement: function() {
                            return (ReputationGet("HouseVincula") >= 50);
                        },
                        Earned: true
                    },
                    {
                        Name: "MagicSchoolMagus",
                        Requirement: function() {
                            return (ReputationGet("HouseMaiestas") >= 100);
                        },
                        Earned: true
                    },
                    {
                        Name: "Maid",
                        Requirement: function() {
                            return (LogQuery("JoinedSorority", "Maid") && !LogQuery("LeadSorority", "Maid"));
                        },
                        Earned: true
                    },
                    {
                        Name: "PonyAlicorn",
                        Requirement: function() {
                            return (SkillGetLevel(Player, "Dressage") >= 10);
                        },
                        Earned: true
                    },
                    {
                    ...
                    },
                    {
                        Name: "Master",
                        Requirement: function() {
                            return LogQuery("ClubMistress", "Management") && !Player.GenderSettings.HideTitles.Male;
                        },
                        Earned: true
                    },
                    {
                        Name: "MasterKidnapper",
                        Requirement: function() {
                            return (ReputationGet("Kidnap") >= 100);
                        },
                        Earned: true
                    },
                    {
                        Name: "Missy",
                        Requirement: function() {
                            return !Player.GenderSettings.HideTitles.Female;
                        }
                    },
                    {
                        Name: "Mistree",
                        Requirement: function() {
                            return LogQuery("ClubMistress", "Management");
                        },
                        Earned: true
                    },
                    {
                        Name: "Mistress",
                        Requirement: function() {
                            return LogQuery("ClubMistress", "Management") && !Player.GenderSettings.HideTitles.Female;
                        },
                        Earned: true
                    },
                    {
                        Name: "InfilrationMole",
                        Requirement: function() {
                            return ((SkillGetLevel(Player, "Infiltration") == 2) || (SkillGetLevel(Player, "Infiltration") == 3));
                        },
                        Earned: true
                    },
                    {
                        Name: "Nawashi",
                        Requirement: function() {
                            return (SkillGetLevel(Player, "Bondage") >= 10);
                        },
                        Earned: true
                    },
                    {
                        Name: "Nurse",
                        Requirement: function() {
                            return ((ReputationGet("Asylum") >= 50) && (ReputationGet("Asylum") < 100));
                        },
                        Earned: true
                    },
                    {
                        Name: "InfilrationOperative",
                        Requirement: function() {
                            return ((SkillGetLevel(Player, "Infiltration") == 8) || (SkillGetLevel(Player, "Infiltration") == 9));
                        },
                        Earned: true
                    },
                    {
                        Name: "MagicSchoolOracle",
                        Requirement: function() {
                            return (ReputationGet("HouseAmplector") >= 100);
                        },
                        Earned: true
                    }, {
                        Name: "Patient",
                    ...
                    {
                        Name: "MagicSchoolSage",
                        Requirement: function() {
                            return (ReputationGet("HouseAmplector") >= 50);
                        },
                        Earned: true
                    },
                    {
                        Name: "PonyUnicorn",
                        Requirement: function() {
                            return (SkillGetLevel(Player, "Dressage") == 7);
                        },
                        Earned: true
                    },
                    {
                    ...
                    {
                        Name: "MagicSchoolSorcerer",
                        Requirement: function() {
                            return (ReputationGet("HouseVincula") >= 100);
                        },
                        Earned: true
                    },
                    {
                    ...
                    },
                    {
                        Name: "AnimeBoy",
                        Requirement: function() {
                            return InventoryAvailable(Player, "AnimeGirl", "Cloth") && !Player.GenderSettings.HideTitles.Male;
                        },
                        Earned: true
                    },
                    {
                        Name: "AnimeGirl",
                        Requirement: function() {
                            return InventoryAvailable(Player, "AnimeGirl", "Cloth") && !Player.GenderSettings.HideTitles.Female;
                        },
                        Earned: true
                    },
                    {
                        Name: "InfilrationSuperspy",
                        Requirement: function() {
                            return (SkillGetLevel(Player, "Infiltration") >= 10);
                        },
                        Earned: true
                    },
                    {
                    ...
                    {
                        Name: "MagicSchoolWarlock",
                        Requirement: function() {
                            return (ReputationGet("HouseCorporis") >= 100);
                        },
                        Earned: true
                    },
                    {
                        Name: "PonyWarm",
                        Requirement: function() {
                            return (SkillGetLevel(Player, "Dressage") == 4);
                        },
                        Earned: true
                    },
                    {
                        Name: "PonyWild",
                        Requirement: function() {
                            return (SkillGetLevel(Player, "Dressage") == 6);
                        },
                        Earned: true
                    },
                    {
                        Name: "MagicSchoolWitch",
                        Requirement: function() {
                            return (ReputationGet("HouseCorporis") >= 50);
                        },
                        Earned: true
                    },
                    {
                        Name: "MagicSchoolWizard",
                        Requirement: function() {
                            return (ReputationGet("HouseMaiestas") >= 50);
                        },
                        Earned: true
                    }
                ];
    ...
    function IsBcxWhisperAllowed(target) {
        ...
        let lovers = [];
        let bcxlist = [];
        let ownershipMember = (Player.Ownership && !Player.Ownership.Name.startsWith("NPC")) ? [Player.Ownership.MemberNumber] : [];
