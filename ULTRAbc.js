        ...
        Action: (args) => {
            if (args === "") {
                let msg = "The bg4 command must be followed by two numbers:\n" +
                    ...
                    "Without BCX: 0 to 191 for official BC backgrounds, 192 to 274 are added if you use the /bg1 command.\n" +
                    "With BCX: 0 to 191 for official BC backgrounds, 192 to 281 are added by BCX, 282 to 355 are added if you use the /bg1 command (some backgrounds have two numbers).\n" +
                    " \n" +
